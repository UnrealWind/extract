  ...
  .service('Session', [function () {
    ...
    Session.create = function (msg) {
      storage.setItem('user',JSON.stringify(msg.user));
        storage.setItem('ticket',msg.ticket);
        storage.setItem('afterLoginUrl',msg.successful);
    };
    ...
    Session.setRoles = function (roles) {
      ...
      Session.getTicket = function () {
          var ticket = storage.getItem('ticket');
          return ticket;
      }

      Session.getAfterLoginUrl = function () {
          var url = storage.getItem('afterLoginUrl');
          return url;
      }
