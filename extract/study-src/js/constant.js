angular.module('infi-basic').value('SYS',{
    // url:'http://192.168.1.163: 8187/platform/',
    //url:'http://192.168.1.22:8080/platform/',
    url:backApi["study-src"].url,
    //url:'http://192.168.1.174:21016/platform/',
    //url:'http://192.168.1.163:8080/platform/',
    remoteUrl:'http://localhost:18080/remote/',
    //remoteUrl:'http://192.168.1.22:8080/remote/',
    STATUS_SUCCESS: 'ok',
    STATUS_BLANK: 'blank',
