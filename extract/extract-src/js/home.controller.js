angular.module('infi-basic')
    .controller('HomeController', ['$rootScope','$scope','$location','DataService','Session','SYS','AuthService','naviServices',function ($rootScope,$scope,$location,DataService,Session,SYS,AuthService,naviServices) {
