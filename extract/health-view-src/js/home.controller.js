angular.module('infi-basic')
    .controller('HomeController',[ '$scope','$routeParams','$rootScope','naviServices','Session','SYS','CheckDeviceService',function ($scope,$routeParams,$rootScope,naviServices,Session,SYS,CheckDeviceService) {
