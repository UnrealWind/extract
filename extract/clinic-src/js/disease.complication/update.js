...
function updateLinks(links) {
    ...
    enter.append("g")
        ...
        .style("fill", function(d) { return changeLineColor(d);(d.PTY=="DEM") ? demColor : (d.PTY=="REP") ? repColor : otherColor; })
    ...
    enter.append("path")
        ...
        .style("stroke",function(d) { return changeLineColor(d);(d.PTY=="DEM") ? demColor : (d.PTY=="REP") ? repColor : otherColor; })
    ...
    enter.append("g")
        .attr("class","node")
        .append("circle")
        .style("fill",function(d) { return changeNodeColor(d);(d.PTY=="DEM") ? demColor : (d.PTY=="REP") ? repColor : otherColor; })
        .style("fill-opacity",0.2)
        .style("stroke-opacity",1)
        .attr("r", function (d) {
            var relatedNode=nodesById[d.CAND_ID];
            //Decrement Related Node
            //console.log(nodesById[d.CAND_ID]);
