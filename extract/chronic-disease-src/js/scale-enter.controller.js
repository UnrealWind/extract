angular.module('infi-basic').controller('ScaleEnterController',
	['$scope','formNaviServices','formServices','FileService','$routeParams','FileUploadServices',
	function($scope,formNaviServices,formServices,FileService,$routeParams,FileUploadServices,){
	...
	(function init() {
		...
		$routeParams.interviewId = $routeParams.interviewId

		$scope.getNaviData($scope.sessionInterview.crfTemplateId, $scope.sessionInterview.id, 0)


		// $routeParams.interviewId = $scope.sessionInterview.id;
		
		// $scope.sessionInterview.crfTemplates.forEach(function (n,i) {
        //     $scope.getNaviData(n.id, $scope.sessionInterview.id, i);
        // });
